...
This project implements a robust quantitative trading strategy designed for the **Nasdaq-100 (QQQ)**. It combines long-term trend following (EMA), tactical dip-buying (Weekly RSI), and strategic asset allocation (Cash or Gold) to maximize returns while strictly managing downside risk. Code is generated by Google Gemini. [![Google Gemini](https://img.shields.io/badge/Google%20Gemini-886FBF?logo=googlegemini&logoColor=fff)](#)
